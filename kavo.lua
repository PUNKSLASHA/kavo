...
function Kavo.CreateLib(kavName, themeList)
    ...
    elseif themeList == "Serpent" then
        ...
        if themeList.SchemeColor == nil then
            themeList.SchemeColor = Color3.fromRGB(0, 61, 141)
        elseif themeList.Background == nil then
            themeList.Background = Color3.fromRGB(21, 21, 21)
        elseif themeList.Header == nil then
            themeList.Header = Color3.fromRGB(7, 7, 7)
        elseif themeList.TextColor == nil then
            themeList.TextColor = Color3.fromRGB(0, 110, 255)
        elseif themeList.ElementColor == nil then
            themeList.ElementColor = Color3.fromRGB(14, 14, 14)
        end
    end
    ...
    function Tabs:NewTab(tabName)
        ...
        page.Visible = false
        page.ScrollBarImageColor3 = themeList.TextColor
        ...
        coroutine.wrap(function()
            ...
            function Elements:NewButton(bname,tipINf, callback)
                ...
                viewInfo.ImageColor3 = Color3.fromRGB(14, 14, 14)
            ...
            function Elements:NewTextBox(tname, tTip, callback)
                ...
                TextBox.PlaceholderColor3 = Color3.fromRGB(0, 110, 255)
                TextBox.PlaceholderText = "Hat Name"
                TextBox.Text = ""
